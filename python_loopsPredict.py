...
# Predicted Results: 1,2,3,4,5,6,7,8,9
#2
for t in range(1, 10, 3):
    print(t)

# Predicted Results: 1,4,7
...
#Predicted Results: 0,1,2,3,4

#4
for j in range(20, 1, -3):
    print(j)

#Predicted Results: 20,17,14,11,8,5,2
...
#Predicted Results: London, Paris, Tokyo
...
#Predicted Results: 0,7,1,13,2,8,3,42, The answer to life, the universe, and everything.
...
#Predicted Results: Hello, 1, Hello, 3, Hello, 5, Hello, 7, Hello, 9
...
#Predicted Results: Hello, 1, World, 3, Hello, 5, World, 7, Hello, 9
...
#Predicted Results: name, Fido, age, 4, trick, rolls over
...
# Forth, I will ask an available instructor
